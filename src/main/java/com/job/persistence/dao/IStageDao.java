...
//            @Param("statut") String statut, Pageable pageable);
    @Query("SELECT S FROM Stage S WHERE S.entreprise.id= :idEntreprise AND S.jobSeeker.nom LIKE :nom AND S.statut LIKE :statut OR S.jobSeeker.prenom LIKE :nom AND S.dateDebut >= :dateDebut AND S.dateDebut <= :dateFin")
    Page<Stage> search(@Param("idEntreprise") long idEntreprise,
            @Param("nom") String nomChercheur, @Param("nom") String prenomChercheur,
            @Param("statut") String statut, @Param("dateDebut") Date dateDebut,
            @Param("dateFin") Date dateFin, Pageable pageable);

    @Query("SELECT S FROM Stage S WHERE S.entreprise.id= :idEntreprise AND S.jobSeeker.nom LIKE :nom OR S.jobSeeker.prenom LIKE :nom AND S.dateDebut >= :dateDebut AND S.dateDebut <= :dateFin")
    Page<Stage> search(@Param("idEntreprise") long idEntreprise,
            @Param("nom") String nomChercheur, @Param("nom") String prenomChercheur,
            @Param("dateDebut") Date dateDebut, @Param("dateFin") Date dateFin, Pageable pageable);

    @Query("SELECT S FROM Stage S WHERE S.jobSeeker.nom LIKE :nom AND S.statut LIKE :statut OR S.jobSeeker.prenom LIKE :nom AND S.dateDebut >= :dateDebut AND S.dateDebut <= :dateFin")
    Page<Stage> search(@Param("nom") String nomChercheur, @Param("nom") String prenomChercheur,
            @Param("statut") String statut, @Param("dateDebut") Date dateDebut,
            @Param("dateFin") Date dateFin, Pageable pageable);

    @Query("SELECT S FROM Stage S WHERE S.jobSeeker.nom LIKE :nom OR S.jobSeeker.prenom LIKE :nom AND S.dateDebut >= :dateDebut AND S.dateDebut <= :dateFin")
    Page<Stage> search(@Param("nom") String nomChercheur, @Param("nom") String prenomChercheur,
            @Param("dateDebut") Date dateDebut, @Param("dateFin") Date dateFin, Pageable pageable);
}
