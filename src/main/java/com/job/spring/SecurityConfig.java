...
public class SecurityConfig extends WebSecurityConfigurerAdapter
{
    ...
    protected void configure(HttpSecurity http) throws Exception
    {
        http.authorizeRequests()
                .antMatchers("/jobSeeker/**/show").authenticated()
                .antMatchers("/jobSeeker/new").authenticated()
                .antMatchers("/jobSeeker/**/edit").authenticated()
                .antMatchers("/jobSeeker/").authenticated()
                .antMatchers("/secteur/**/show").authenticated()
                .antMatchers("/secteur/new").authenticated()
                .antMatchers("/secteur/**/edit").authenticated()
