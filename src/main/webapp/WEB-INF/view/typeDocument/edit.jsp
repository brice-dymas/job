    ...
    <tiles:putAttribute name="body">
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <h4>
                    ...
                    <spring:message code="typeDocument.modifier" />
                    : ${typeDocument.nom}
                </h4>
                <hr/>
            </div>
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <spring:url value="/typeDocument/${typeDocument.id}/update" var="typeDocument_update" htmlEscape="true"/>
                <form:form method="post" commandName="typeDocument" action="${typeDocument_update}">
